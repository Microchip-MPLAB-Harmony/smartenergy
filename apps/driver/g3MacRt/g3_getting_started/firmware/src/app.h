...
typedef struct
{
    ...
    DRV_HANDLE g3MacRtHandle;
    
    bool g3MacRtException;
    
    uint32_t g3MacRtErrorUnexpected;
    
    uint32_t g3MacRtErrorCritical;
    
    uint32_t g3MacRtErrorReset;
    
    uint32_t g3MacRtErrorUnknow;
    
    MAC_RT_TX_PARAMETERS_OBJ g3MacRtTxParameters;
    
    MAC_RT_TX_CFM_OBJ g3MacRtTxConfirm;
