...
/****************** PRIME PLC allowed channels definition *******************/
/* Configure PRIME PLC allowed channels and initial channel. It should be
 * coherent with the hardware used (coupling board) */

/* PLCOUP011: Allow all channels (Branch 0 for Channel 1; Branch 1 for Channels
 * 2 to 8). DACC_CFG_CH2_8_COUP11 should be selected below
 * (DACC_CFG_TABLE_CH2_8). */
#define APP_CONFIG_PRIME_CHANNEL_INI           1
#define APP_CONFIG_PRIME_ALLOWED_CHANNELS      (CHN_1_ENABLED | \
                                                CHN_2_ENABLED | \
                                                CHN_3_ENABLED | \
                                                CHN_4_ENABLED | \
                                                CHN_5_ENABLED | \
...
/* PLCOUP006: Allow Channels 3-8 (FCC). DACC_CFG_CH2_8_COUP06 should be selected
 * below (DACC_CFG_TABLE_CH2_8). */
/* #define APP_CONFIG_PRIME_CHANNEL_INI           3
#define APP_CONFIG_PRIME_ALLOWED_CHANNELS      (CHN_3_ENABLED | \
                                                CHN_4_ENABLED | \
                                                CHN_5_ENABLED | \
                                                CHN_6_ENABLED | \
                                                CHN_7_ENABLED | \
 ...
 * TX & Coupling parameters for each channel. Each channel needs its own
 * calibration. In PRIME, the PLC transceiver is initialized in Channel 1
 * (CENELEC-A). TX & Coupling parameters should be reconfigured every time the
 * channel is changed.
 *
 * PRIME CHANNEL 1 (CENELEC-A): Recommended to use PLCOUP007_v2/PLCOUP008_v2/
 * PLCOUP011_v1 coupling board (Single Branch).
 ...
 * Tool should be used.
 *
 * PRIME CHANNEL 2 - 8 (FCC and CENELEC-BCD): Recommended to use PLCOUP006_v2
 * (Double Branch) / PLCOUP011_v1 (Single Branch) coupling board.
 * IMPORTANT!!! The following values are the default values, calibrated for MCHP
 ...
 * (1 dB steps) for normal behavior. Next levels use always LOW mode.
 * Maximum value is 8 */
 ...
 * corresponds to the first attenuation levels (1 dB steps) */
 ...
 * (up to 8) corresponds to the first attenuation levels (1 dB steps) */
...
#define THRESHOLD_VLO_TABLE_CH2 {0, 0, 0, 0, 0, 0, 0, 0, \
                                 ...
                                 100000, 100000, 100000, 100000}
#define THRESHOLD_VLO_TABLE_CH3 THRESHOLD_VLO_TABLE_CH2
#define THRESHOLD_VLO_TABLE_CH4 THRESHOLD_VLO_TABLE_CH2
#define THRESHOLD_VLO_TABLE_CH5 THRESHOLD_VLO_TABLE_CH2
#define THRESHOLD_VLO_TABLE_CH6 THRESHOLD_VLO_TABLE_CH2
#define THRESHOLD_VLO_TABLE_CH7 THRESHOLD_VLO_TABLE_CH2
#define THRESHOLD_VLO_TABLE_CH8 THRESHOLD_VLO_TABLE_CH2
 ...
 * frequency response */
#define PREDIST_HI_TABLE_CH1    {0x756E, 0x7396, 0x730A, 0x72EB, 0x72B2, \
                                 0x7433, 0x755E, 0x75D7, 0x769E, 0x76A4, \
                                 0x77C3, 0x7851, 0x7864, 0x78A0, 0x78BA, \
                                 0x7918, 0x79B6, 0x79E9, 0x7ACC, 0x7B06, \
                                 0x7B30, 0x7B27, 0x7C1E, 0x7B96, 0x7A76, \
                                 0x7B12, 0x7AFD, 0x7C40, 0x7C5E, 0x7B48, \
                                 0x7B8A, 0x7C64, 0x7C42, 0x7BCD, 0x7AFD, \
                                 0x7A5F, 0x7A03, 0x7A9D, 0x7A1A, 0x7A4A, \
                                 0x79FC, 0x7984, 0x7A0D, 0x79CC, 0x792E, \
                                 0x780D, 0x7676, 0x75E4, 0x747A, 0x7251, \
                                 0x707E, 0x6E96, 0x6E30, 0x6D44, 0x6DBD, \
                                 0x6C9A, 0x6C3C, 0x6CF8, 0x6CA4, 0x6CDF, \
                                 0x6C59, 0x6B2C, 0x6CB9, 0x6C1F, 0x6B6D, \
                                 0x6BF5, 0x6AF0, 0x6A55, 0x6955, 0x674F, \
                                 0x6841, 0x685D, 0x670F, 0x6904, 0x6967, \
                                 0x6B01, 0x6C31, 0x6C2A, 0x6D82, 0x6F58, \
                                 0x6E62, 0x6F18, 0x6EE7, 0x7069, 0x717B, \
                                 0x7120, 0x7170, 0x72FB, 0x7491, 0x75B3, \
                                 0x75A2, 0x7664, 0x784A, 0x7A52, 0x7B51, \
                                 0x7D5A, 0x7FFF}
#define PREDIST_HI_TABLE_CH2_8  {0x7FFF, 0x7FFF, 0x7FFF, 0x7FFF, 0x7FFF, \
...
#define PREDIST_VLO_TABLE_CH1   {0x7FFF, 0x7F2B, 0x7E38, 0x7CD3, 0x7B38, \
                                 0x7972, 0x77D6, 0x7654, 0x74AE, 0x7288, \
                                 0x70C0, 0x6E9A, 0x6D24, 0x6B80, 0x6A2F, \
                                 0x6852, 0x674E, 0x65DA, 0x652E, 0x637E, \
                                 0x6292, 0x6142, 0x60CC, 0x5FF8, 0x5F6D, \
                                 0x5EC2, 0x5E6F, 0x5E55, 0x5E43, 0x5E02, \
                                 0x5E5B, 0x5EB3, 0x5F4A, 0x5FD7, 0x604C, \
                                 0x60FC, 0x61F3, 0x6297, 0x63A9, 0x643D, \
                                 0x654A, 0x6634, 0x675C, 0x6824, 0x6910, \
                                 0x69A4, 0x6A73, 0x6B6F, 0x6C15, 0x6CCD, \
                                 0x6D64, 0x6E4B, 0x6ED3, 0x6F44, 0x6F85, \
                                 0x70A1, 0x70AF, 0x71B2, 0x7149, 0x71F3, \
                                 0x7203, 0x7279, 0x71FB, 0x72B4, 0x7281, \
                                 0x72A4, 0x7262, 0x72BD, 0x7295, 0x72CC, \
                                 0x729E, 0x7288, 0x7244, 0x7279, 0x726C, \
                                 0x7230, 0x71B9, 0x70D8, 0x7045, 0x7052, \
                                 0x6F8D, 0x6F3D, 0x6EB0, 0x6E6A, 0x6E76, \
                                 0x6E1C, 0x6D7A, 0x6D84, 0x6D50, 0x6D45, \
                                 0x6CF2, 0x6CA9, 0x6C92, 0x6CBA, 0x6C69, \
                                 0x6C27, 0x6C02}
...
/* PLC_ID_DACC_TABLE_CFG: DAC Table configuration (PRIME CHANNEL 1: CENELEC-A).
 * Configuration for PLCOUP007/PLCOUP008/PLCOUP011 (only use Branch 0) */
#define DACC_CFG_TABLE_CH1      {0x00000000, 0x00002120, 0x0000073F, \
                                 0x00003F3F, 0x00000333, 0x00000000, \
                                 0x546000FF, 0x1A1A1A1A, 0x00002020, \
                                 0x00000044, 0x0FD20005, 0x00000355, \
                                 0x0F000000, 0x001020F0, 0x00000355, \
                                 0x0F000000, 0x001020FF}

/* PLC_ID_DACC_TABLE_CFG: DAC Table configuration (PRIME CHANNEL 2 - 8: FCC and
 * CENELEC-BCD).
 * Configuration for PLCOUP006 (use Branch 0 for VERY_LOW and Branch 1 for HIGH)
 */
#define DACC_CFG_CH2_8_COUP06   {0x00000000, 0x10102120, 0x033F073F, \
                                 0x3F3F3F3F, 0x00000FFF, 0x00000000, \
                                 0xA8C000FF, 0x1B1B1B1B, 0x10101010, \
 ...
 * PLCOUP006). With PLCOUP011 in FCC it does not make sense to use HIGH TX mode
 * (PLC_ID_CFG_AUTODETECT_IMPEDANCE should be 0 or 2 and PLC_ID_CFG_IMPEDANCE
 * should be 2 (VERY_LOW)). */
#define DACC_CFG_CH2_8_COUP11   {0x00000000, 0x21202120, 0x073F073F, \
                                 0x3F3F3F3F, 0x00000FFF, 0x00000000, \
                                 0xA8C000FF, 0x1B1B1B1B, 0x10101010, \
                                 0x00001111, 0x04380006, 0x000003AA, \
 ...
 * Choose PLCOUP006/PLCOUP011 configuration. This should be coherent with
 * APP_CONFIG_PRIME_ALLOWED_CHANNELS and APP_CONFIG_PRIME_CHANNEL_INI
 * definitions. */
#define DACC_CFG_TABLE_CH2_8    DACC_CFG_CH2_8_COUP11
/* #define DACC_CFG_TABLE_CH2_8    DACC_CFG_CH2_8_COUP06 */
