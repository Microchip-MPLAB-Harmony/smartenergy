...
#define PREDIST_HI_TABLE       {0x670A, 0x660F, 0x676A, 0x6A6B, 0x6F3F, 0x7440, \
...
#define PREDIST_VLO_TABLE      {0x7FFF, 0x7DB1, 0x7CE6, 0x7B36, 0x772F, 0x7472, \
...
#define GAIN_HI                {142, 70, 336}
#define GAIN_VLO               {474, 230, 597}
