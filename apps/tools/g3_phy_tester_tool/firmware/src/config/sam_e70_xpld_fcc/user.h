 ...
 * These values have been got from ATPLCOUP006v2 coupling board */    
    
/* Number of TX levels: Max.8 */
#define NUM_TX_LEVELS           8

/* Coupling Values to define RMS values in High/Very Low impedance */
#define MAX_RMS_HI_TABLE       {1355, 960, 681, 485, 345, 246, 177, 129}
#define MAX_RMS_VLO_TABLE      {5656, 4174, 2877, 1987, 1413, 1020, 736, 532}
...
#define GAIN_HI                {109, 50, 256}
#define GAIN_VLO               {364, 180, 408}
...
#define DACC_CFG_TABLE          DACC_CFG_TABLE_COUP11
